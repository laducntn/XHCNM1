...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO = LAD_Blockchain.UTXOs.get(i.transactionOutputId);
        }

        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < LAD_Blockchain.minimumTransaction) {
            System.out.println("Đầu vào của giao dịch quá bé: " + getInputsValue());
            System.out.println("Vui lòng nhập số tiền giao dịch lớn hơn " + LAD_Blockchain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            LAD_Blockchain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            LAD_Blockchain.UTXOs.remove(i.UTXO.id);
        }
