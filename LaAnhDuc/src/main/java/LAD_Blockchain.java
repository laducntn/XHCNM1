...
public class LAD_Blockchain {

    public static ArrayList<VNPT_DUC> blockchain = new ArrayList<VNPT_DUC>();
    ...
    public static void main(String[] args) {
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, walletA.publicKey, 400f, null);
        ...
        VNPT_DUC genesis = new VNPT_DUC("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);

        //Thử nghiệm
        VNPT_DUC block1 = new VNPT_DUC(genesis.hash);
        ...
        VNPT_DUC block2 = new VNPT_DUC(block1.hash);
        ...
        VNPT_DUC block3 = new VNPT_DUC(block2.hash);
    ...
    public static Boolean isChainValid() {
        VNPT_DUC currentBlock;
        VNPT_DUC previousBlock;
        ...
        for(int i=1; i < blockchain.size(); i++) {
            ...
            for(int t=0; t <currentBlock.transactions.size(); t++) {
                ...
                if( currentTransaction.outputs.get(1).reciepient != currentTransaction.sender) {
                    System.out.println("#Đầu ra của giao dich(" + t + ") không đúng với người gửi.");
                    return false;
                }
    ...
    public static void addBlock(VNPT_DUC newBlock) {
